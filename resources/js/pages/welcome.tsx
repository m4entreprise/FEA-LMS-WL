...
export default function Welcome({
    ...
    const tagline = page.props.brand?.tagline ?? 'Learn. Track. Certify.';
            ...
            <div className="flex min-h-screen flex-col items-center bg-background p-6 text-foreground lg:justify-center lg:p-8">
                <header className="mb-6 w-full max-w-[335px] text-sm not-has-[nav]:hidden lg:max-w-4xl">
                    <nav className="flex items-center justify-end gap-4">
                        {auth.user ? (
                            <Link
                                href={dashboard()}
                                className="inline-block rounded-sm border border-input bg-background px-5 py-1.5 text-sm leading-normal text-foreground hover:bg-accent"
                            >
                                Dashboard
                            </Link>
                        ) : (
                            <>
                                <Link
                                    href={login()}
                                    className="inline-block rounded-sm border border-transparent px-5 py-1.5 text-sm leading-normal text-foreground hover:bg-accent"
                                >
                                    Log in
                                </Link>
                                {canRegister && (
                ...
                <div className="flex w-full items-center justify-center opacity-100 transition-opacity duration-750 lg:grow starting:opacity-0">
                    <main className="flex w-full max-w-[335px] flex-col-reverse lg:max-w-4xl lg:flex-row">
                        <div className="flex-1 rounded-br-lg rounded-bl-lg bg-card p-6 pb-12 text-[13px] leading-[20px] shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] lg:rounded-tl-lg lg:rounded-br-none lg:p-20">
                            <h1 className="mb-1 font-medium">{appName}</h1>
                            <p className="mb-2 text-muted-foreground">
                                {tagline}
                                <br />
                                A modern LMS to deliver courses, track progress, and issue verifiable certificates.
                            </p>
                            ...
                            <ul className="mb-4 flex flex-col lg:mb-6">
                                <li className="relative flex items-center gap-4 py-2 before:absolute before:top-1/2 before:bottom-0 before:left-[0.4rem] before:border-l before:border-border">
                                    <span className="relative bg-card py-1">
                                        <span className="flex h-3.5 w-3.5 items-center justify-center rounded-full border border-border bg-background shadow-[0px_0px_1px_0px_rgba(0,0,0,0.03),0px_1px_2px_0px_rgba(0,0,0,0.06)]">
                                            <span className="h-1.5 w-1.5 rounded-full bg-muted-foreground/40" />
                                        </span>
                                    </span>
                                    <span>
                                        Deliver structured courses (modules, lessons, quizzes) with a responsive learner experience.
                                    </span>
                                </li>
                                <li className="relative flex items-center gap-4 py-2 before:absolute before:top-0 before:bottom-1/2 before:left-[0.4rem] before:border-l before:border-border">
                                    ...
                                    <span>
                                        Track completions and issue certificates with a public verification page.
                                    </span>
                                </li>
                            </ul>
